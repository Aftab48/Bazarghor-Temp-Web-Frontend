...
export const api = {
  ...
  admin: {
    ...
    updateProfile: (formData) =>
      apiClient.put("/admin/update", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    changePassword: (id, data) =>
      apiClient.post(`/admin/change-password/${id}`, data),
  },
  ...
  staff: {
    ...
    createAdmin: (formData) =>
      apiClient.post("/staff/add-admin", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    updateAdmin: (id, formData) =>
      apiClient.put(`/staff/update-admin/${id}`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    deleteAdmin: (id) => apiClient.delete(`/staff/delete-admin/${id}`),
    updateSelfAdmin: (formData) =>
      apiClient.put("/staff/update-admin", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    updateSubAdmin: (formData) =>
      apiClient.put("/staff/update-sub-admin", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    changeAdminPassword: (id, data) =>
      apiClient.post(`/staff/admin-change-password/${id}`, data),
    changeSubAdminPassword: (id, data) =>
      apiClient.post(`/staff/sub-admin-change-password/${id}`, data),

    // User Management
    verifyUserStatus: (userId, data) =>
      apiClient.put(`/users/verify-status/${userId}`, data),

    // Vendor Management
    createVendor: (formData) =>
      apiClient.post("/users/create-vendor", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    updateVendor: (id, formData) =>
      apiClient.put(`/users/update-vendor/${id}`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    createDeliveryPartner: (formData) =>
      apiClient.post("/users/create-delivery-partner", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    getAllDeliveryPartners: () =>
      apiClient.get("/users/get-delivery-partner-list"),
    getDeliveryPartnerById: (id) =>
      apiClient.get(`/users/get-delivery-partner/${id}`),
    updateDeliveryPartner: (id, formData) =>
      apiClient.put(`/users/update-delivery-partner/${id}`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    deleteDeliveryPartner: (id) =>
      apiClient.delete(`/users/delete-delivery-partner/${id}`),

    // Customer Management
    createCustomer: (formData) =>
      apiClient.post("/users/create-customer", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    updateCustomer: (id, formData) =>
      apiClient.put(`/users/update-customer/${id}`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
  ...
  customer: {
    register: (formData) =>
      apiClient.post("/customers/create-customer", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    login: (data) => apiClient.post("/customers/login", data),
    getProfile: () => apiClient.get("/customers/profile"),
    updateProfile: (formData) =>
      apiClient.put("/customers/update-profile", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    updateAddress: (addressId, data) =>
      apiClient.put(`/customers/address/${addressId}`, data),
    deleteAddress: (addressId) =>
      apiClient.delete(`/customers/address/${addressId}`),
  },

  // Vendor endpoints
  vendor: {
    register: (formData) =>
      apiClient.post("/vendors/create-vendor", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    getProfile: () => apiClient.get("/vendors/profile"),
    updateProfile: (formData) =>
      apiClient.put("/vendors/update-profile", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
  ...
  deliveryPartner: {
    ...
    updateProfile: (formData) =>
      apiClient.put("/delivery-partner/update-profile", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
  ...
  otp: {
    sendRegistrationOTP: (data) =>
      apiClient.post("/otp/send-otp-registration", data),
    verifyRegistrationOTP: (data) =>
      apiClient.post("/otp/verify-otp-registration", data),
  ...
  products: {
    ...
    getAll: (params = {}) =>
      apiClient.get("/products/get-products-list", { params }),
    getById: (id) => apiClient.get(`/products/get-productsById/${id}`),
    update: (id, formData) =>
      apiClient.put(`/products/update-productsById/${id}`, formData, {
        headers: { "Content-Type": "multipart/form-data" },
      }),
    ...
    admin: {
      create: (formData) =>
        apiClient.post("/products/admin/add-product", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        }),
      getAll: (params = {}) =>
        apiClient.get("/products/admin/get-products-list", { params }),
      getById: (id) => apiClient.get(`/products/admin/get-product/${id}`),
      update: (id, formData) =>
        apiClient.put(`/products/admin/update-product/${id}`, formData, {
          headers: { "Content-Type": "multipart/form-data" },
        }),
  ...
  cart: {
    ...
    updateItem: (productId, data) =>
      apiClient.put(`/customers/cart/update-item/${productId}`, data),
  ...
  orders: {
    ...
    addHistory: (orderId, data) =>
      apiClient.post(`/customers/order/${orderId}/history`, data),
    updatePayment: (orderId, data) =>
      apiClient.post(`/customers/order/${orderId}/payment`, data),
  },
  ...
  store: {
    ...
    customer: {
      getOpenStores: (params = {}) =>
        apiClient.get("/customers/store/open-stores", { params }),
      getStoreProducts: (storeId) =>
        apiClient.get(`/customers/store/products/${storeId}`),
    },
    // Vendor/Admin store endpoints
    toggleStatus: (storeId, data) =>
      apiClient.put(`/store/${storeId}/open-close`, data),
    // Admin store endpoints
    admin: {
      getAll: (params = {}) =>
        apiClient.get("/store/admin/get-store", { params }),
      getById: (id) => apiClient.get(`/store/admin/get-store-by-id/${id}`),
      update: (id, data) =>
        apiClient.put(`/store/admin/update-store-by-id/${id}`, data),
    },
  },
  ...
  vendorSubscription: {
    ...
    renew: (id, data) =>
      apiClient.put(`/vendors/renew-subscription/${id}`, data),
  },

  // Delivery Partner order endpoints
  deliveryOrders: {
    respond: (orderId, data) =>
      apiClient.post(`/delivery-order/respond-order/${orderId}`, data),
    pickup: (orderId, data) =>
      apiClient.put(`/delivery-order/pickup-order/${orderId}`, data),
    deliver: (orderId, data) =>
      apiClient.put(`/delivery-order/deliver-order/${orderId}`, data),
  ...
  adminOrders: {
    ...
    getOrderHistory: (orderId) =>
      apiClient.get(`/admin/order/${orderId}/history`),
  },
  ...
  adminVendorSubscription: {
    ...
    renew: (id, data) =>
      apiClient.put(`/admin/vendor-subscription/${id}/renew`, data),
  ...
  mappls: {
    ...
    geocode: (params = {}) =>
      apiClient.get("/mappls/places/geocode", { params }),
