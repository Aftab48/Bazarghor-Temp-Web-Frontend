...
const CustomerLogin = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const response = await api.customer.sendOTP({ mobNo: formData.mobNo });
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await api.customer.resendOTP({ mobNo: formData.mobNo });
        ...
        <Card title="🛍️ Customer Login">
          ...
          <div style={{
            ...
            <div style={{ fontFamily: 'monospace', marginTop: '0.5rem' }}>
              POST /api/customers/login/send-otp<br />
              POST /api/customers/login (verify)<br />
              POST /api/customers/login/resend
            </div>
          </div>

          <div style={{ textAlign: 'center', marginTop: '1rem' }}>
            <span style={{ color: '#718096' }}>Don't have an account? </span>
            <a href="/customer/register" style={{ color: '#667eea', fontWeight: '600' }}>
              Register here
            </a>
          </div>
        </Card>
